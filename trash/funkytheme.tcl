...
# theme.tcl --
#
# original: Arc pixmap theme for the ttk package.
# original: Copyright (c) 2015 Sergei Golovan <sgolovan@nes.ru>
#
# Theme engine and processor for Ttk with unfocus on portability, but design
# of custom theme things
...
#              -altindicator $colors(-bg)             \
#              -disabledaltindicator $colors(-bg)
        ...
        #
         ...
         #######################################################################
         # Checkbutton without label and a "loop" icon
         #######################################################################
         ttk::style element create Loop.Checkbutton.indicator image \
             [list $I(loop-activated) \
                 disabled            $I(loop-activated) \
                 {active selected}   $I(loop-activated) \
                 {pressed selected}  $I(loop-activated) \
                 active              $I(loop-activated) \
                 selected            $I(loop-activated) \
                 {disabled selected} $I(loop-activated) \
             ] -sticky nesw

         ttk::style layout Loop.TCheckbutton {
             Checkbutton.padding -sticky nswe -children {
                 Loop.Checkbutton.indicator -sticky nswe {}
             }
         }

         #######################################################################
         # Checkbutton without label and a "random" icon
         #######################################################################
         ttk::style element create Rand.Checkbutton.indicator image \
             [list $I(face-monkey) \
                 disabled            $I(face-monkey) \
                 {active selected}   $I(face-monkey) \
                 {pressed selected}  $I(face-monkey) \
                 active              $I(face-monkey) \
                 selected            $I(face-monkey) \
                 {disabled selected} $I(face-monkey) \
             ] -sticky nesw

         ttk::style layout Rand.TCheckbutton {
             Checkbutton.padding -sticky nswe -children {
                 Rand.Checkbutton.indicator -sticky nswe {}
             }
         }

         #######################################################################
         # "Flat" button of the same color of the frames
         # IT IS THE SAME AS TOOLBUTTON, DELETE THIS
         #######################################################################
         ttk::style element create Flat.Button.button image \
             [list $I(button-flat) \
                 pressed     $I(button-flat-active) \
                 active      $I(button-flat-active) \
                 disabled    $I(button-flat-insensitive) \
             ] -border 1 -padding {0 0} -sticky ew

         ttk::style layout Flat.TButton {
             Flat.Button.button -children {
                 Button.label -side left -expand true
             }
         }
         ...
         # "Small" buttons
         #######################################################################
         ttk::style element create Small.Button.button image [list $I(button) \
                 pressed     $I(button) \
                 active      $I(button) \
                 disabled    $I(button) \
             ] -border 3 -padding {1 1} -sticky ewns


         ttk::style layout Small.TButton {
             Small.Button.button -children {
                 Button.focus -children {
                     Button.padding -children {
                         Button.label -side left -expand true
                     }
         ...
         # "SmallBoxLeft" button
         #######################################################################
         ttk::style element create SmallBoxLeft.Button.button \
            image [list $I(button-box-left) \
                 pressed     $I(button-active) \
                 active      $I(button-hover) \
                 disabled    $I(button-insensitive) \
             ] -border 0 -padding {0 0} -sticky ewns


         ttk::style layout SmallBoxLeft.TButton {
             SmallBoxLeft.Button.button -children {
                 Button.focus -children {
                     Button.padding -children {
                         Button.label -side left -expand true
                     }
         ...
         #######################################################################
         # "SmallBoxRight" button
         #######################################################################
         ttk::style element create SmallBoxRight.Button.button image [list $I(button-box-right) \
                 pressed     $I(button-active) \
                 active      $I(button-hover) \
                 disabled    $I(button-insensitive) \
             ] -border 3 -padding {0 0} -sticky ewns


         ttk::style layout SmallBoxRight.TButton {
             SmallBoxRight.Button.button -children {
                 Button.focus -children {
                     Button.padding -children {
                         Button.label -side left -expand true
                     }
         ...
         #######################################################################
         # "SmallBoxCenter" button
         #######################################################################
         ttk::style element create SmallBoxCenter.Button.button image [list $I(button-box-center) \
                 pressed     $I(button-active) \
                 active      $I(button-hover) \
                 disabled    $I(button-insensitive) \
             ] -border 3 -padding {0 0} -sticky ewns
         ...
         ttk::style layout SmallBoxCenter.TButton {
             SmallBoxCenter.Button.button -children {
                 Button.focus -children {
                     Button.padding -children {
                         Button.label -side left -expand true
                     }
         ...
         #######################################################################
         # "MediumBoxLeft" button
         #######################################################################
         ttk::style element create MediumBoxLeft.Button.button \
            image [list $I(button-box-left) \
                 pressed     $I(button-active) \
                 active      $I(button-hover) \
                 disabled    $I(button-insensitive) \
         ...
         ttk::style layout MediumBoxLeft.TButton {
             MediumBoxLeft.Button.button -children {
                 Button.focus -children {
                     Button.padding -children {
                         Button.label -side left -expand true
                     }
         ...
         #######################################################################
         # "MediumBoxRight" button
         #######################################################################
         ttk::style element create MediumBoxRight.Button.button image [list $I(button-box-right) \
                 pressed     $I(button-active) \
                 active      $I(button-hover) \
                 disabled    $I(button-insensitive) \
             ] -border 3 -padding {0 0} -sticky ewns
         ...
         ttk::style layout MediumBoxRight.TButton {
             MediumBoxRight.Button.button -children {
                 Button.focus -children {
                     Button.padding -children {
                         Button.label -side left -expand true
                     }
         ...
         #######################################################################
         # "MediumBoxCenter" button
         #######################################################################
         ttk::style element create MediumBoxCenter.Button.button image [list $I(button-box-center) \
                 pressed     $I(button-active) \
                 active      $I(button-hover) \
                 disabled    $I(button-insensitive) \
             ] -border 3 -padding {0 0} -sticky ewns
         ...
         ttk::style layout MediumBoxCenter.TButton {
             MediumBoxCenter.Button.button -children {
                 Button.focus -children {
                     Button.padding -children {
                         Button.label -side left -expand true
                     }
         ...
         # ContrastFrame
         #######################################################################
         ttk::style layout Inverse.TFrame
         ttk::style configure Inverse.TFrame -background $colors(-selectbg)

         #######################################################################
         # ContrastLabel
         #######################################################################
         ttk::style layout Inverse.TLabel
         ttk::style configure Inverse.TLabel -background $colors(-selectbg) \
         ...
         # FieldFrame
         #######################################################################
         ttk::style layout Field.TFrame
         ttk::style configure Field.TFrame -background $colors(-window)

         #######################################################################
         # FieldLabel
         #######################################################################
         ttk::style layout Field.TLabel
         ttk::style configure Field.TLabel -background $colors(-window)
         ...
         ttk::style element create Entry.field \
             image [list $I(entry-border-bg-solid) \
                         focus $I(entry-border-bg-solid) \
                         disabled $I(entry-border-bg-solid)] \
         ...
         ttk::style element create Treeheading.cell \
             image [list $I(treeviewheading1) pressed $I(treeviewheading1)] \
         ...
         ttk::style configure Loop.TCheckbutton -padding 0
         ttk::style configure Rand.TCheckbutton -padding 0
         ttk::style configure Small.TButton -padding {4 2 4 2} -anchor center -height 26
         ttk::style configure SmallBoxLeft.TButton -padding {4 2 4 2} -anchor center
         ttk::style configure SmallBoxRight.TButton -padding {4 2 4 2} -anchor center
         ttk::style configure SmallBoxCenter.TButton -padding {4 2 4 2} -anchor center
         ...
         ttk::style configure TEntry -background $colors(-window) -foreground $colors(-fg)

         # Treeview
         ttk::style configure Treeview -background $colors(-window) -foreground $colors(-treeitem)
    ...
    proc load_images {imgdir} {
        variable I
        foreach file [glob -directory $imgdir ximage*.png] {
            set img [string map {"ximage-" ""} [file tail [file rootname $file]]]
    ...
    load_images [file join [file dirname [info script]] imgs]
    #load_images [file join [file dirname [info script]] funky imgs]
    ttk::style theme create Funky -parent default -settings $style_config
    #ttk::style theme create Funky -parent clam -settings $style_config
}


set reconf_version 0
proc ::funky::theme::reconfigure {edited} {
    global reconf_version
    variable style_config
    variable colors
    variable I
    array set colors $edited
    #puts $colors
    ttk::style theme create Funky-$reconf_version -parent clam -settings $style_config
    set newname Funky-$reconf_version
    ttk::style theme use $newname
    incr reconf_version
    return $newname
}
