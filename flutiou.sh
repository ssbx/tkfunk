...
usage () {
    ...
    echo "          The default is \"flutio -I\" but can be anything that "
    echo "          forward \"flutio -I\" stdin/stdout to the current process."
    echo
    echo "          Example to connect to a distant flutio process via ssh:"
    echo "              $ flutiou -c \"ssh someuser@somehost flutio -I\""
